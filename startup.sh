...
server {
    ...
    # SECURITY: Hide process endpoints — return 404 for everything except POST
    # (POST requests fall through to the PHP-FPM handler below)
    location ~ ^/(process_encode|process_decode)\.php$ {
        limit_except POST {
            return 404;
        }
